...
<head>
    ...
    <title>Register - Platform UMKM</title>
    ...
    <div class="min-h-screen flex">
        <div class="hidden lg:flex lg:w-[40%] flex-col justify-between p-8 lg:p-12 relative overflow-hidden">
            ...
            <div class="flex-1 flex flex-col justify-center relative z-10">
                <h1 class="text-4xl xl:text-5xl font-black text-white italic mb-4 animate-slide-in-left" style="opacity: 0; animation-delay: 0.1s;">Welcome!</h1>
                <p class="text-white/80 text-lg max-w-sm animate-slide-in-left" style="opacity: 0; animation-delay: 0.2s;">
                    Bergabunglah dengan ribuan UMKM lainnya dan mulai kembangkan bisnis Anda bersama kami.
                </p>
            </div>
        ...
        <div class="w-full lg:w-[60%] flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
            <div class="w-full max-w-md py-8">
                ...
                <h2 class="text-3xl lg:text-4xl font-black text-neutral-900 mb-2 animate-fade-in-up" style="opacity: 0; animation-delay: 0.02s;">Create your account</h2>
                <p class="text-neutral-500 mb-8 animate-fade-in-up" style="opacity: 0; animation-delay: 0.04s;">It's free and easy</p>

                <form action="{{ route('register') }}" method="POST" class="space-y-5">
                    @csrf

                    <div class="animate-fade-in-up" style="opacity: 0; animation-delay: 0.05s;">
                    ...
                    <div class="animate-fade-in-up" style="opacity: 0; animation-delay: 0.07s;">
                        <label class="block text-sm font-semibold text-neutral-700 mb-2">E-mail</label>
                    ...
                    <div class="animate-fade-in-up" style="opacity: 0; animation-delay: 0.09s;">
                    ...
                    <div class="animate-fade-in-up" style="opacity: 0; animation-delay: 0.11s;">
                        ...
                        <p class="mt-1 text-sm text-blue-500">Must be 8 characters at least</p>
                        @error('password')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>

                    <div class="flex items-start gap-3 animate-fade-in-up" style="opacity: 0; animation-delay: 0.13s;">
                        <input type="checkbox" name="terms" id="terms" class="mt-1 w-4 h-4 text-neutral-900 border-neutral-300 rounded focus:ring-neutral-900" required>
                        <label for="terms" class="text-sm text-neutral-600">
                            By creating an account means you agree to the
                            <a href="#" class="font-bold text-neutral-900 hover:underline">Terms and Conditions</a>,
                            and our
                            <a href="#" class="font-bold text-neutral-900 hover:underline">Privacy Policy</a>
                        </label>
                    </div>
                    ...
                    <button type="submit" class="w-full py-4 bg-primary-500 text-white font-bold rounded-full hover:bg-primary-600 transition-all hover:shadow-lg animate-fade-in-up"
                        style="opacity: 0; animation-delay: 0.15s;">
                        Sign Up
                    </button>
                </form>

                <div class="flex items-center gap-4 my-8 animate-fade-in-up" style="opacity: 0; animation-delay: 0.17s;">
                    <div class="flex-1 h-px bg-neutral-200"></div>
                    <span class="text-sm text-neutral-400">or do it via other accounts</span>
                    <div class="flex-1 h-px bg-neutral-200"></div>
                </div>

                <div class="flex justify-center gap-4 animate-fade-in-up" style="opacity: 0; animation-delay: 0.19s;">
                ...
                <p class="text-center mt-8 text-neutral-600 animate-fade-in-up" style="opacity: 0; animation-delay: 0.6s;">
